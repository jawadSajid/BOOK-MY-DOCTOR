...
<html>
<head>
	<link rel="stylesheet"name="changecss" type="text/css" href="../../css/search by/doc gender.css"/>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
	<script type="text/javascript" src="../../js/search by/doc gender.js"></script>
	<link rel="icon" href="../../images/title.png" type="image/png">
	<title>Search by Doctor Gender</title>
</head>
<body>
	<header>
		...
		<div>
			<section class="search-doctor">
			 <?php
				...
				{
					$gender=$_GET['gender'];
					$sql = "SELECT * from Doctor where sex = '$gender';";
					$r3 = $conn->query($sql);
