...
<html>
<head>
	<link rel="stylesheet"name="changecss" type="text/css" href="../../css/search by/doc name.css"/>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
	<script type="text/javascript" src="../../js/search by/doc name.js"></script>
	<link rel="icon" href="../../images/title.png" type="image/png">
	<title>Search by Doctor Name</title>
</head>
<body>
	<header>
	...
	<section>
		...
		<div class="search-by-name">
			<form method="get">
				<div class="name">
					<label for="doc-name">Search By First Name:</label>
					<input id="doc-name" type="text" placeholder="First Name" name="fname">
				</div>

				<div class="name">
					<label for="doc-name">Search By Last Name:</label>
					<input id="doc-name" type="text" placeholder="Last Name" name="lname">
				</div>
		...
		<div class="search-by-alphabet">
			<h3>
				...
				<form action="" method="get">
					<div class="name">
						<label for="alphabet">Search By Alphabet:</label>
						<input id="alphabet" type="text" name="alphabet" pattern="[A-Za-z]{1}" title="Please enter only one letter" placeholder="Alphabet to search" required>
					</div>
					<div class="search">
						<input type="submit" value="Search">
					</div>
		...
		<section class="search-doctor">
			 <?php
				if(isset($_GET['alphabet']) || isset($_GET['fname']) || isset($_GET['lname']))
				{

					if(isset($_GET['alphabet']))
					{
					$al=$_GET['alphabet'];
					$sql = "SELECT * from Doctor where fname like '$al%';";
					$r3 = $conn->query($sql);
					}
					else
					{	
						...
						$sql = "select * from Doctor where fname ='$fname' or lname = '$lname';";
						$r3 = $conn->query($sql);
					}
