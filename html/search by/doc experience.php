...
<html>
<head>
	<link rel="stylesheet"name="changecss" type="text/css" href="../../css/search by/doc experience.css"/>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
	<script type="text/javascript" src="../../js/search by/doc experience.js"></script>
	<link rel="icon" href="../../images/title.png" type="image/png">
	<title>Search by Doctor Experience</title>
</head>
<body>
	<header>
	...
	<section>
		...
		<div class="search-by-experience">
			<form method="get">
				<div class="experience">
					<label for="experience">Experience in years:</label>
					<input id="experience" type="number" placeholder="Experience Years" name="exp" required>
				</div>
				<div class="search">
			...
			<section class="search-doctor">
			 <?php
				if(isset($_GET['exp']))
				{
					...
					$sqlx = "Select doc_ide from Doc_Experience where total_years = '$exp';";
