...
<html>
<head>
	<link rel="stylesheet"name="changecss" type="text/css" href="../../css/search by/doc location.css"/>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
	<script type="text/javascript" src="../../js/search by/doc location.js"></script>
	<link rel="icon" href="../../images/title.png" type="image/png">
	<title>Search by Doctor Location</title>
</head>
<body>
	<header>
	...
	<section>
		...
		<div class="search-by-location">
			<form method="get">
				<div class="location">
					<label for="doc-location">Search By location:</label>
					<input id="doc-location" type="text" placeholder="Enter City/Town Name" name="location" required>
				</div>
				<div class="search">
		...
		<div>
				...
				{
					$city=$_GET['location'];
					$sql = "SELECT doc_ida as did,fname,lname,sex,email,phone_no,fee from Doctor_Addresses DA join Addresses A ON DA.add_id = A.aid join Doctor D ON DA.doc_ida = D.did and A.city_town='$city';";
					$r3 = $conn->query($sql);
