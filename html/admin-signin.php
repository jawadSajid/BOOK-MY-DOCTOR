...
<html>
<head>
	<link rel="stylesheet"name="changecss" type="text/css" href="../css/admin-signin.css"/>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
	<script type="text/javascript" src="../js/admin-signin.js"></script>
...
<body>
	...
	<section class="user-sign-in">
		...
		<form action ="../login/admin-login.php" method="post">
			<div class="email">
		...
		<div>
			...
			<p>
				Use a valid login and Password to access Administrator Panel and manage Book My Doctor.
			</p>
